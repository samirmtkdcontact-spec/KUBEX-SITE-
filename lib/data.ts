/**
 * Données réelles et vérifiées — deux niches : pompe à chaleur (PAC) et
 * photovoltaïque (PV). Chaque chiffre est accompagné de sa source et d'un
 * contexte affiché au survol — AUCUNE donnée inventée.
 */
