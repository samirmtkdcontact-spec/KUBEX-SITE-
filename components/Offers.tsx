...
const offers: Offer[] = [
  {
    name: "Lancement",
    tagline: "Pour tester Meta Ads sérieusement, sans s'engager.",
    price: "490 €",
    priceNote: "/ mois · gestion (hors budget pub)",
    commitment: "Sans engagement",
    features: [
      "Audit initial de votre marché",
      "1 campagne d'acquisition ciblée",
      "Création des visuels et messages",
  ...
  {
    name: "Croissance",
    tagline: "Pour installer une acquisition régulière et l'optimiser.",
    price: "890 €",
    priceNote: "/ mois · gestion (hors budget pub)",
    ...
    features: [
      ...
      "Optimisation bimensuelle des annonces",
      "Tableau de bord de suivi partagé",
      "Point téléphonique mensuel",
    ],
  },
  {
    name: "Domination",
    tagline: "Pour les artisans et PME qui veulent prendre leur zone.",
    price: "Sur mesure",
    priceNote: "selon ambition et périmètre",
    commitment: "Périmètre défini ensemble",
    features: [
      "Stratégie multi-campagnes avancée",
      "Production de contenus dédiée",
      "Optimisation continue & reporting détaillé",
      "Accompagnement prioritaire",
      "Conseil sur l'ensemble de l'acquisition",
    ],
  },
];
