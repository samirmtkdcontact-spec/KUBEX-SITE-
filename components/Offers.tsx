...
const offers: Offer[] = [
  {
    ...
    features: [
      "Audit de votre zone et des logements F/G à cibler",
      "1 campagne de génération de leads ciblée",
      "Création des visuels et messages orientés urgence légale & aides",
  ...
  {
    name: "Croissance",
    tagline: "Le Système Kube complet isolation pour un flux de leads régulier.",
    price: "Tarif sur devis",
    priceNote: "Audit gratuit inclus",
