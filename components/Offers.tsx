...
const offers: Offer[] = [
  {
    ...
    features: [
      "Audit de votre zone de chalandise et de vos concurrents",
      "1 campagne de prise de rendez-vous ciblée",
      "Création des visuels et messages orientés bilan auditif & 100 % Santé",
      "Suivi mensuel des rendez-vous et des coûts",
      "Recommandation de budget pub adaptée",
    ],
  },
  {
    name: "Croissance",
    tagline: "Le Système Kube complet pour un flux de rendez-vous régulier.",
    price: "Tarif sur devis",
    priceNote: "Audit gratuit inclus",
