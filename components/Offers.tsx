...
const offers: Offer[] = [
  {
    ...
    features: [
      "Audit de votre zone d'intervention et de vos concurrents",
      "1 campagne de génération de leads ciblée",
      "Création des visuels et messages orientés économies & autoconsommation",
  ...
  {
    name: "Croissance",
    tagline: "Le Système Kube complet pour un flux de leads régulier.",
    price: "Tarif sur devis",
    priceNote: "Audit gratuit inclus",
